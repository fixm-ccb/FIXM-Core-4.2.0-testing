...
5)	The FIXM model should not be influenced by the concerns of a single or small group of stakeh olders.
...
15)	Information elements in FIXM must be semantically consistent with corresponding elements in AIOX.
