...
The Perl script developed<sup><a href="#how-to-generate-xml-schemas/post-processing-the-fixm-schemas?id=notes">[note 1]</a></sup> for this task can be downloaded [here](https://github.com/fixm-ccb/FIXM-Core-4.2.0-testing/blob/master/docs/assets/downloads/postprocess.pl).
